...
import { setProvider, WalletError } from '@/web/lib/nimiq.js';
import { installMockApi, installTestWallet } from './mock-server.js';
import { captureReferralFromUrl, readReferral } from '@/web/lib/referral.js';
...
describe('Nimoto app', () => {
  ...
  it('keeps a wallet control in the header and shows the address once connected', async () => {
    installMockApi();
    installTestWallet();
    ...
    await signIn(user);
    expect(within(header).getByText(/^NQ07…0001$/)).toBeInTheDocument();
  });
