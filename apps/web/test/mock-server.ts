...
import { setProvider, type NimiqProvider } from '../src/lib/nimiq.js';

export const TEST_ADDRESS = 'NQ07 0000 0000 0000 0000 0000 0000 0000 0001';

export function installMockWallet(overrides: Partial<NimiqProvider> = {}): NimiqProvider {
 ...
 * live backend. It mirrors the real response contracts from @nimoto/shared.
 */
